...
public class VideoCastNotificationService extends Service {
    ...
    private static int sSmallIconResourceID = Integer.MAX_VALUE;
    ...
    protected void build(MediaInfo info, Bitmap bitmap, boolean isPlaying)
        ...
        if (sSmallIconResourceID != Integer.MAX_VALUE) {
            builder.setSmallIcon(sSmallIconResourceID);
        }
    ...
    public static void setSmallNotificationIcon(int resourceid) {
        sSmallIconResourceID = resourceid;
    }
}
