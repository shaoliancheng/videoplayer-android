...
public class VideoCastManager extends BaseCastManager
    ...
    private int smallNotificationIconId = Integer.MAX_VALUE;

    public void setSmallNotifiactionIcon(int iconId) {
        smallNotificationIconId = iconId;
    }
    ...
    private boolean startNotificationService() {
        ...
        VideoCastNotificationService.setSmallNotificationIcon( smallNotificationIconId );
