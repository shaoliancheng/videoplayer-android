...
public class HlsChunkSource implements HlsTrackSelector.Output {
  ...
  protected long[] variantBlacklistTimes;
  ...
  public void setVariants(int selected){
  ...
  protected int getNextVariantIndex(TsChunk previousTsChunk, long playbackPositionUs) {
